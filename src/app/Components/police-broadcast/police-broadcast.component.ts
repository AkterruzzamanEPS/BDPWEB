...
@Component({
  selector: 'app-police-broadcast',
  standalone: true,
  imports: [CommonModule, FormsModule, AgGridAngular, PaginationComponent, NgxEditorModule],
  templateUrl: './police-broadcast.component.html',
  styleUrl: './police-broadcast.component.scss',
      providers: [DatePipe],
    encapsulation: ViewEncapsulation.None,
})
export class PoliceBroadcastComponent  implements OnInit {
  ...
  private GetTouristSpot() {
    ...
    this.oTouristSpotFilterDto.Type=6;
  ...
  public InsertTouristSpot() {
    ...
    this.oTouristSpotRequestDto.Type=6;
