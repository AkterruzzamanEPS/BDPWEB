...
@Component({
  selector: 'app-refueling-stations',
  standalone: true,
  imports: [CommonModule, FormsModule, AgGridAngular, RouterModule, PaginationComponent, NgxEditorModule, FormsModule],
  templateUrl: './refueling-stations.component.html',
  styleUrl: './refueling-stations.component.scss',
  providers: [DatePipe],
  encapsulation: ViewEncapsulation.None,
})
export class RefuelingStationsComponent implements OnInit {
